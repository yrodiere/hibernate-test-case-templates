 ...
 */
package org.hibernate.search.bugs.arquillian;
...
public class LoggingConfigurator {
	...
	private final ModelNode ADDRESS_JPA_LOGGER = PathAddress
			.pathAddress( "subsystem", "logging" )
			.append( "logger", "org.jboss.as.jpa" )
			.toModelNode();

	private final ModelNode ADDRESS_HIBERNATE_LOGGER = PathAddress
			.pathAddress( "subsystem", "logging" )
			.append( "logger", "org.hibernate" )
			.toModelNode();
	...
	public void afterStart(@Observes AfterStart event, ArquillianDescriptor descriptor) throws IOException {
		...
		addLogger( ADDRESS_JPA_LOGGER, "TRACE" );
		addLogger( ADDRESS_HIBERNATE_LOGGER, "TRACE" );
	}

	public void beforeShutdown(@Observes BeforeStop event, ArquillianDescriptor descriptor) throws IOException {
		removeLogger( ADDRESS_HIBERNATE_LOGGER );
		removeLogger( ADDRESS_JPA_LOGGER );
