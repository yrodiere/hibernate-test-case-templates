...
public class DslFilterByIT extends SearchITBase {
	...
	public void testDslFilterBy() {
		...
		List<YourAnnotatedEntity> result = controller.searchUsingDslFilterBy( "example" );
